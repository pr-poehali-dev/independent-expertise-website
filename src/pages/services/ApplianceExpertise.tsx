...
const faq = [
  {
    question: "Холодильник перестал морозить через полгода. Продавец отказывает в возврате — говорит, что мы сами сломали. Что делать?",
    answer: "В период гарантийного срока продавец обязан доказать, что дефект возник по вине потребителя (ст. 18 ЗоЗПП). Если продавец провёл экспертизу и сослался на «нарушение условий эксплуатации» — закажите независимую. Мы установим истинную причину: производственный дефект компрессора, утечку хладагента с завода или иное основание."
  },
  {
    question: "Стиральная машина затопила квартиру. Можно ли взыскать ущерб с продавца?",
    answer: "Да. Если экспертиза докажет, что затопление произошло из-за производственного дефекта (трещина бака, бракованный патрубок, дефект клапана), продавец несёт ответственность за причинённый вред по ст. 14 ЗоЗПП. Мы составим заключение как для досудебной претензии, так и для судебного разбирательства."
  },
  {
    question: "Телевизор сгорел. Магазин говорит — скачок напряжения. Как оспорить?",
    answer: "Скачок напряжения — самый распространённый отказ продавцов. Однако современная техника должна выдерживать нормативные перепады сети. Экспертиза устанавливает характер повреждения платы: если горение произошло по причине заводского брака цепи питания или отсутствия защиты — это производственный дефект."
  },
  {
    question: "Можно ли вернуть деньги за бытовую технику, купленную больше года назад?",
    answer: "Да, если гарантийный срок ещё не истёк или с момента покупки прошло менее 2 лет. При существенном недостатке — в течение всего срока службы товара (ст. 19 ЗоЗПП). Важно получить заключение, фиксирующее производственный характер дефекта."
  },
];
...
export default function ApplianceExpertise() {
  return (
    <ServiceLayout
      ...
      description="Независимое заключение о производственных дефектах холодильников, стиральных машин, телевизоров и другой бытовой техники."
      faq={faq}
    >
