...
const faq = [
  {
    question: "Чем отличается возврат на маркетплейсе от возврата в обычный магазин?",
    answer: "Маркетплейс (Ozon, Wildberries) — лишь площадка. Продавец — отдельное юридическое лицо или ИП. При споре маркетплейс выступает посредником и обязан содействовать урегулированию. Если продавец отказывает, независимое экспертное заключение — официальное основание для открытия спора и принудительного возврата средств через платформу."
  },
  {
    question: "Ozon/WB отклонили мою заявку на возврат. Что дальше?",
    answer: "После отклонения заявки вы вправе открыть спор на платформе, приложив заключение независимого эксперта. Маркетплейсы принимают такие документы. Если спор проигран — следующий шаг: досудебная претензия продавцу и, при отказе, исковое заявление в суд. Мы помогаем на всех этапах."
  },
  {
    question: "Продавец на маркетплейсе не реагирует на претензии. Можно ли подать в суд?",
    answer: "Да. Продавец несёт полную ответственность по ЗоЗПП независимо от того, торгует ли он через маркетплейс. Исковое заявление подаётся по месту жительства покупателя или нахождения продавца. Госпошлина по делам о защите прав потребителей не уплачивается."
  },
  {
    question: "Товар пришёл с повреждениями — это производственный брак или повреждение при доставке?",
    answer: "Это принципиальный вопрос для распределения ответственности. Если повреждение внешнее — ответственен перевозчик или маркетплейс. Если внутреннее (дефект компонента) — продавец. Наша экспертиза точно устанавливает происхождение повреждения, что определяет, к кому предъявлять претензию."
  },
  {
    question: "Как долго занимает возврат через маркетплейс при наличии заключения?",
    answer: "На практике: после подачи заключения в поддержку Ozon или WB решение принимается в течение 3–10 рабочих дней. Продавцу даётся срок на ответ. При положительном исходе деньги возвращаются на счёт в течение 3–5 дней после решения."
  },
];
...
export default function MarketplaceReturn() {
  return (
    <ServiceLayout
      ...
      description="Помогаем вернуть деньги за бракованный товар на Ozon и Wildberries. Официальное заключение и сопровождение до результата."
      faq={faq}
    >
