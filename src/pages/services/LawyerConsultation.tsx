...
const faq = [
  {
    q: "Нужна ли юридическая консультация, если я просто хочу вернуть телефон?",
    a: "Не всегда, но она помогает избежать ошибок. Типичные случаи, когда консультация необходима: продавец уже отказал, прошло более 15 дней с покупки, товар из перечня технически сложных, ситуация нестандартная (подарок, рассрочка, б/у). Мы оцениваем ваши шансы и даём конкретный план действий."
  },
  {
    q: "Что делать, если продавец провёл свою экспертизу и говорит, что я сам сломал?",
    a: "Вы имеете право оспорить результаты экспертизы продавца. Закажите независимую экспертизу — если она покажет производственный брак, продавец обязан возместить её стоимость. При подаче иска в суд именно вы выбираете, чьей экспертизе доверять больше, а суд оценивает оба заключения."
  },
  {
    q: "Как правильно написать претензию продавцу?",
    a: "Претензия должна содержать: ваши данные, описание товара и дефекта, дату покупки, конкретное требование (возврат денег / замена / ремонт), срок исполнения (установлен ЗоЗПП), реквизиты для перевода. Мы составим претензию с учётом всех требований — она должна быть направлена заказным письмом с описью вложения."
  },
  {
    q: "Сколько времени есть у продавца на ответ?",
    a: "По ЗоЗПП: возврат денег — 10 дней, замена товара — 7 дней (или 20 при необходимости проверки), ремонт — не более 45 дней. Каждый день просрочки — неустойка 1% от стоимости товара. Фиксируйте дату отправки претензии — это точка отсчёта."
  },
];
