...
const faq = [
  {
    question: "Кто несёт ответственность за производственный брак — продавец или производитель?",
    answer: "По закону о защите прав потребителей (ст. 18 ЗоЗПП) ответственность перед покупателем несёт продавец. Именно он обязан принять товар, провести проверку качества и вернуть деньги или заменить изделие. Производитель отвечает только по гарантии, если срок гарантии ещё не истёк."
  },
  {
    question: "Что такое производственный брак и как его доказать?",
    answer: "Производственный брак — дефект, возникший до передачи товара покупателю: заводская ошибка сборки, некачественные комплектующие, нарушение технологии. Доказывается независимым экспертным заключением товароведа, где указана причина и момент возникновения дефекта."
  },
  {
    question: "В течение какого срока можно вернуть сломанный телефон?",
    answer: "В течение 15 дней с момента покупки — безоговорочно при любом дефекте. После 15 дней и до конца гарантийного срока — если дефект существенный (неоднократный или невозможно устранить). После окончания гарантии, но в течение 2 лет — если экспертиза докажет производственное происхождение дефекта."
  },
  {
    question: "Магазин отказывается принять телефон и говорит, что это моя вина. Что делать?",
    answer: "Это типичная ситуация. Продавец обязан сам провести проверку качества или экспертизу за свой счёт. Если вы не согласны с её результатами — заказываете независимую экспертизу. При подтверждении производственного брака продавец обязан возместить стоимость экспертизы и вернуть деньги за товар."
  },
  {
    question: "Можно ли вернуть телефон, купленный на Ozon или Wildberries?",
    answer: "Да. Маркетплейс выступает посредником, но ответственность за качество несёт продавец. Наше заключение принимается службой поддержки Ozon и Wildberries как основание для возврата средств через механизм разрешения споров."
  },
];
...
export default function PhoneExpertise() {
  return (
    <ServiceLayout
      ...
      description="Независимое заключение о производственном браке смартфонов, планшетов и умных часов. Принимается маркетплейсами и судами."
      faq={faq}
    >
      {/* Что проверяем */}
