...
const faq = [
  {
    q: "Чем отличается стоимостная экспертиза от обычной товароведческой?",
    a: "Товароведческая экспертиза устанавливает факт дефекта и его причину. Стоимостная — определяет рыночную стоимость товара или размер ущерба, причинённого дефектом. Часто оба вида совмещаются в одном заключении: сначала фиксируется брак, затем рассчитывается утрата товарной стоимости."
  },
  {
    q: "Для чего нужна стоимостная экспертиза?",
    a: "Для взыскания ущерба в суде, расчёта страховой выплаты, определения компенсации при возврате товара с износом, споров о цене при поставке некачественной продукции, таможенных и налоговых спорах. Заключение принимается судами общей юрисдикции и арбитражными судами."
  },
  {
    q: "Как рассчитывается «утрата товарной стоимости»?",
    a: "Утрата товарной стоимости (УТС) — разница между рыночной ценой товара без дефекта и его стоимостью с дефектом или после ремонта. Рассчитывается по методикам Минюста с учётом марки, модели, года выпуска, региона, степени повреждения. Эта сумма взыскивается с виновного сверх стоимости ремонта."
  },
  {
    q: "Можно ли оспорить заключение стоимостной экспертизы противоположной стороны?",
    a: "Да. Если продавец или страховая представили собственную экспертизу с заниженной стоимостью, мы проводим рецензию: анализируем применённые методики, исходные данные, расчёты. При выявлении ошибок составляем рецензию-возражение для суда, которая служит основанием для назначения повторной экспертизы."
  },
];
